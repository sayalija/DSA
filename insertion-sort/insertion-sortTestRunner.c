...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_7_for_sorting_unsorted_string_values");
	setup();
		test_7_for_sorting_unsorted_string_values();
	tearDown();
	testEnded();
	testStarted("test_8__for_sorting_unsorted_string_values");
	setup();
		test_8__for_sorting_unsorted_string_values();
	tearDown();
	testEnded();
